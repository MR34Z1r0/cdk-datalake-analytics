...
from pyspark.sql.functions import col, lit, when, concat, trim, row_number, lower, coalesce
...
try:
    ...
    spark_controller.upsert(df_dim_medio_transporte, data_paths.CADENA, target_table_name, id_columns, partition_columns_array)    
except Exception as e:
    logger.error(e)
    raise