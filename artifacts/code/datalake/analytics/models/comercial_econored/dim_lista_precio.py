...
try:
    ...
    df_m_lista_precio = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "m_lista_precio", cod_pais=cod_pais)
...
try:
    ...
    spark_controller.upsert(df_dim_lista_precio, data_paths.COMERCIAL_ECONORED, target_table_name, id_columns, partition_columns_array)    
except Exception as e:
    logger.error(e)
    raise