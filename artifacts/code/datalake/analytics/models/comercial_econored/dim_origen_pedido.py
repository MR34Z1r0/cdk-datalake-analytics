...
try:
    ...
    df_m_origen_pedido = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "m_origen_pedido", cod_pais=cod_pais)
...
try:
    ...
    spark_controller.upsert(df_dim_origen_pedido, data_paths.COMERCIAL_ECONORED, target_table_name, id_columns, partition_columns_array)    
except Exception as e:
    logger.error(e)
    raise