...
try:
    ...
    df_m_medio_transporte = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "m_medio_transporte", cod_pais=cod_pais)
...
try:
    ...
    spark_controller.upsert(df_dim_medio_transporte, data_paths.COMERCIAL_ECONORED, target_table_name, id_columns, partition_columns_array)    
except Exception as e:
    logger.error(e)
    raise