...
try:
    ...
    df_dim_cliente = spark_controller.read_table(data_paths.COMERCIAL_ECONORED, "dim_cliente", cod_pais=cod_pais)
    df_dim_producto = spark_controller.read_table(data_paths.COMERCIAL_ECONORED, "dim_producto", cod_pais=cod_pais)
...
try:
    ...
    spark_controller.write_table(df_fact_cliente_venta, data_paths.COMERCIAL_ECONORED, target_table_name, partition_columns_array)
except Exception as e:
    logger.error(e) 
    raise