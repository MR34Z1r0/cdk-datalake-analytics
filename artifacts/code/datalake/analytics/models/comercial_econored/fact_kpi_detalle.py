...
try:
    ...
    df_m_tipo_venta = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "m_tipo_venta", cod_pais=cod_pais)
    df_t_pedido = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "t_pedido", cod_pais=cod_pais)
    df_t_pedido_detalle = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "t_pedido_detalle", cod_pais=cod_pais)
    df_t_venta = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "t_venta", cod_pais=cod_pais)
    df_t_venta_detalle = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "t_venta_detalle", cod_pais=cod_pais)
    df_t_visita = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "t_visita", cod_pais=cod_pais)
...
try:
    ...
    spark_controller.write_table(df_fact_kpi_detalle, data_paths.COMERCIAL_ECONORED, target_table_name, partition_columns_array)
except Exception as e:
    logger.error(e) 
    raise