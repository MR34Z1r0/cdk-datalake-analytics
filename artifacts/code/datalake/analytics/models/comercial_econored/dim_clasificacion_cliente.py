...
try:
    ...
    df_m_clasificacion_cliente = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "m_clasificacion_cliente", cod_pais = cod_pais).cache()
...
try:
    ...
    spark_controller.upsert(df_dim_clasificacion_cliente, data_paths.COMERCIAL_ECONORED, target_table_name, column_keys, partition_keys) 
except Exception as e:
    logger.error(e)
    raise