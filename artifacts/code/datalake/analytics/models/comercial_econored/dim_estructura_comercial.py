...
try:
    ...
    df_m_modulo = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "m_modulo", cod_pais=cod_pais)
    df_m_pais = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "m_pais", cod_pais=cod_pais)
    df_m_estructura_comercial = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "m_estructura_comercial", cod_pais=cod_pais)
    df_m_modelo_atencion = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "m_modelo_atencion", cod_pais=cod_pais)
    df_m_responsable_comercial = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "m_responsable_comercial", cod_pais=cod_pais) 
...
try:
    ...
    spark_controller.upsert(df_dim_estructura_comercial, data_paths.COMERCIAL_ECONORED, target_table_name, id_columns, partition_columns_array)
except Exception as e:
    logger.error(e)
    raise