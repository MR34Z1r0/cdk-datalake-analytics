...
try:
    ...
    df_m_articulo = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "m_articulo", cod_pais=cod_pais)
...
try:
    ...
    spark_controller.upsert(df_dim_producto, data_paths.COMERCIAL_ECONORED, target_table_name, id_columns, partition_columns_array)    
except Exception as e:
    logger.error(e)
    raise