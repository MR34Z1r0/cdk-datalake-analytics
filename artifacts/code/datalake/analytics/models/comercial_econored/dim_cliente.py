...
try:
    ...
    df_m_cliente = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "m_cliente", cod_pais=cod_pais) 
    df_m_eje_territorial = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "m_eje_territorial", cod_pais=cod_pais) 
    df_m_asignacion_modulo = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "m_asignacion_modulo", cod_pais=cod_pais) 
...
try:
    ...
    spark_controller.upsert(df_dim_cliente, data_paths.COMERCIAL_ECONORED, target_table_name, id_columns, partition_columns_array)
except Exception as e:
    logger.error(e)
    raise