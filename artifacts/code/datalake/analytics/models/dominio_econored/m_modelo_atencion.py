...
try: 
    ...
    df_m_modelo_atencion = spark_controller.read_table(data_paths.BIG_BAGIC, "m_modelo_atencion", cod_pais=cod_pais)
...
try:
    ...
    spark_controller.upsert(tmp_m_modelo_atencion, data_paths.DOMINIO_ECONORED, target_table_name, id_columns, partition_columns_array)
