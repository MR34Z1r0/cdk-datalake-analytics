...
try: 
    ...
    df_m_origen_pedido = spark_controller.read_table(data_paths.BIG_BAGIC, "m_origen_pedido", cod_pais=cod_pais)
...
try:
    ...
    spark_controller.upsert(tmp_m_origen_pedido, data_paths.DOMINIO_ECONORED, target_table_name, id_columns, partition_columns_array)
