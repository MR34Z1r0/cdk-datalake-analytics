...
try:
    ...
    df_t_historico_venta_filter = (
        ...
        .select(
            ...
            concat_ws("|", col("tp.cod_compania"), col("tp.cod_sucursal"),col("tp.cod_almacen"), col("tp.cod_documento_venta"), col("nro_documento_venta")).alias("id_venta"),
    ...
    spark_controller.write_table(df_t_venta, data_paths.DOMINIO_ECONORED, target_table_name, partition_columns_array)
except Exception as e:
    logger.error(e) 
    raise 