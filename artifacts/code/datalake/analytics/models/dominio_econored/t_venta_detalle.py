...
try:
    ...
    df_m_linea = spark_controller.read_table(data_paths.BIG_BAGIC, "m_linea", cod_pais=cod_pais)
    df_m_operacion = spark_controller.read_table(data_paths.BIG_BAGIC, "m_operacion", cod_pais=cod_pais)
...
try:
    ...
    spark_controller.write_table(df_t_venta_detalle, data_paths.DOMINIO_ECONORED, target_table_name, partition_columns_array)
except Exception as e:
    logger.error(e)
    raise 