...
try:
    ...
    df_m_modulo = spark_controller.read_table(data_paths.BIG_BAGIC, "m_modulo", cod_pais=cod_pais)
    df_m_ruta = spark_controller.read_table(data_paths.BIG_BAGIC, "m_ruta", cod_pais=cod_pais) 
    df_m_sucursal = spark_controller.read_table(data_paths.BIG_BAGIC, "m_sucursal", cod_pais=cod_pais)
...
try:
    ...
    spark_controller.upsert(tmp_dominio_modulo, data_paths.DOMINIO_ECONORED, target_table_name, id_columns, partition_columns_array)
