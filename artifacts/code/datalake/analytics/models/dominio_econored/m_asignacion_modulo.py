...
try:
    ...
    conf_origen = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "conf_origen")
...
try:
    ...
    df_final = df_final.dropDuplicates(["id_asignacion_modulo", "id_pais"])

    id_columns = ["id_asignacion_modulo"]
    partition_columns_array = ["id_pais"]
    logger.info(f"starting upsert of {target_table_name}")
    spark_controller.upsert(df_final, data_paths.DOMINIO_ECONORED, target_table_name, id_columns, partition_columns_array)
