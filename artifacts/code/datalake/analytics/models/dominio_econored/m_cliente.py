...
try:
    ...
    df_m_cliente_bm = spark_controller.read_table(data_paths.BIG_BAGIC, "m_cliente", cod_pais=cod_pais)
    df_m_estructura_cliente = spark_controller.read_table(data_paths.BIG_BAGIC, "m_asignacion_modulo", cod_pais=cod_pais)
    df_m_tipo_cliente = spark_controller.read_table(data_paths.BIG_BAGIC, "m_tipo_cliente", cod_pais=cod_pais)
    df_m_cuenta_clave = spark_controller.read_table(data_paths.BIG_BAGIC, "m_cuenta_clave", cod_pais=cod_pais)
    df_m_canal = spark_controller.read_table(data_paths.BIG_BAGIC, "m_canal", cod_pais=cod_pais)
    df_m_giro = spark_controller.read_table(data_paths.BIG_BAGIC, "m_giro", cod_pais=cod_pais)
    ...
    df_conf_origen = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "conf_origen")
...
try:
    ...
    spark_controller.upsert(tmp_dominio_m_cliente, data_paths.DOMINIO_ECONORED, target_table_name, id_columns, partition_columns_array)
