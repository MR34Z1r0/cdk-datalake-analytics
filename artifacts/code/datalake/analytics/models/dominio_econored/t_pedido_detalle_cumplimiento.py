...
try:
    ...
    df_i_relacion_proced_venta = spark_controller.read_table(data_paths.BIG_BAGIC, "i_relacion_proced_venta", cod_pais=cod_pais)
    df_m_procedimiento = spark_controller.read_table(data_paths.BIG_BAGIC, "m_procedimiento", cod_pais=cod_pais)
    df_m_articulo = spark_controller.read_table(data_paths.BIG_BAGIC, "m_articulo", cod_pais=cod_pais)
 
    df_t_historico_pedido = spark_controller.read_table(data_paths.BIG_BAGIC, "t_documento_pedido", cod_pais=cod_pais)
    df_t_historico_pedido_detalle = spark_controller.read_table(data_paths.BIG_BAGIC, "t_documento_pedido_detalle", cod_pais=cod_pais)
    df_t_historico_pedido_ades = spark_controller.read_table(data_paths.BIG_BAGIC, "t_documento_pedido_ades", cod_pais=cod_pais)
    df_t_historico_pedido_ades_detalle = spark_controller.read_table(data_paths.BIG_BAGIC, "t_documento_pedido_ades_detalle", cod_pais=cod_pais)
    df_t_historico_almacen = spark_controller.read_table(data_paths.BIG_BAGIC, "t_movimiento_inventario", cod_pais=cod_pais)
    df_t_historico_venta = spark_controller.read_table(data_paths.BIG_BAGIC, "t_documento_venta", cod_pais=cod_pais)
    df_t_historico_venta_detalle = spark_controller.read_table(data_paths.BIG_BAGIC, "t_documento_venta_detalle", cod_pais=cod_pais) 
...
try:
    ...
    df_t_pedido_detalle_cumplimiento = (
        ...
        .select(
            ...
            concat(col("vthv.cod_compania"), lit("|"), col("vthv.cod_articulo")).alias("id_articulo"),
    ...
    spark_controller.write_table(df_t_pedido_detalle_cumplimiento, data_paths.DOMINIO_ECONORED, target_table_name, partition_columns_array)
except Exception as e:
    logger.error(e)
    raise 