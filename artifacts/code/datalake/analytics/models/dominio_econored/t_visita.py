...
try:
    ...
    df_conf_origen = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "conf_origen").cache()
...
try:
    ...
    spark_controller.write_table(df_t_visita, data_paths.DOMINIO_ECONORED, target_table_name, partition_columns_array)
except Exception as e:
    logger.error(e) 
    raise 