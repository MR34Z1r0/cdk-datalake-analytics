...
try:
    ...
    m_transportista = spark_controller.read_table(data_paths.BIG_BAGIC, "m_transportista", cod_pais=cod_pais)
    m_persona = spark_controller.read_table(data_paths.BIG_BAGIC, "m_persona", cod_pais=cod_pais)
    m_tipo_transportista = spark_controller.read_table(data_paths.BIG_BAGIC, "m_tipo_transportista", cod_pais=cod_pais)
...
try:
    ...
    spark_controller.upsert(tmp, data_paths.DOMINIO_ECONORED, target_table_name, id_columns, partition_columns_array)
