...
try: 
    ...
    df_conf_origen_dom = spark_controller.read_table(data_paths.DOMINIO_ECONORED, "conf_origen")
...
try:
    ...
    spark_controller.upsert(tmp_dominio_m_eje_territorial, data_paths.DOMINIO_ECONORED, target_table_name, id_columns, partition_columns_array)
