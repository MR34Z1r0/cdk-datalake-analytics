...
try:
    tmp_dominio_m_sucursal = (
        ...
        .select(
            concat(col("ms.cod_compania"), lit("|"), col("ms.cod_sucursal"))
            .cast(StringType())
            .alias("id_sucursal"),
    ...
    spark_controller.upsert(tmp_dominio_m_sucursal, data_paths.DOMINIO_ECONORED, target_table_name, id_columns, partition_columns_array)
